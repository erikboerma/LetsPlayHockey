    ...
    <form onSubmit={submitGame}>
      <MDBContainer className="modalButtonMargin">
        ...
        <MDBModal isOpen={modal} toggle={toggle} fullHeight position="right">
          ...
          <MDBModalBody>
            <MDBInput label="Location" name="location" onChange={handleChange}>{props.location}</MDBInput>
            <MDBInput label="Date" name="date" onChange={handleChange}>{props.date}</MDBInput>
            <MDBInput label="Time" name="time" onChange={handleChange}>{props.time}</MDBInput>
          </MDBModalBody>
          <MDBModalFooter>
